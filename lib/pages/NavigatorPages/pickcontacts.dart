  ...
  getContact() async {
    if (contacts.isEmpty) {
      ...
      if (permission == PermissionStatus.granted) {
        ...
        // Use a Set to store unique contact information
        Set<Map<String, String>> uniqueContacts = {};
        ...
        contacts = uniqueContacts.toList();
                  ...
                  (pickedName != '')
                      ? Container(
                          ...
                          child: Button(
                              ...
                              color: (_isLoading) ? Colors.grey : secondaryAppColor,
