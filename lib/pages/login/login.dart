...
class _LoginState extends State<Login> with TickerProviderStateMixin {
  ...
  final TextEditingController _sequenceNumber = TextEditingController();
  final TextEditingController _dateOfBirthGregorian = TextEditingController();
  final TextEditingController _dateOfBirthHijri = TextEditingController();
...
/*
                                          ...
                                          Container(
                                            ...
                                            child: TextField(
                                              controller: _dateOfBirthGregorian,
                                              readOnly: true,
                                              onTap: () =>
...
// Hijri Date Input
                                          Container(
                                            ...
                                            child: TextField(
                                              controller: _dateOfBirthHijri,
                                              readOnly: true,
                                              onTap: () =>
                                                  selectHijriDate(context),
                                              decoration: const InputDecoration(
                                                hintText:
                                                    'Date of Birth (Hijri)',
                                                border: InputBorder.none,
...
*//*
                                          Container(
                                            ...
                                            child: TextField(
                                              ...
                                              decoration: const InputDecoration(
                                                hintText: 'Car Number, ex (د ر ب 1234)',
                                                border: InputBorder.none,
                                                  ...
                                                  child: Row(
                                                    mainAxisAlignment:
                                                        MainAxisAlignment
                                                            .spaceBetween,
                                                    children: [
                                                      // First part input (larger box for letters)
                                                      Expanded(
                                                        flex:2,
                                                        child: Container(
                                                          decoration: BoxDecoration(
                                                      ...
                                                      // Spacer between first part and the numbers
                                                      SizedBox(
                                                          width: media.width * 0.02),

                                                      // Generate the smaller inputs for the number part
                                                      ...List.generate(
                                                        3,
                                                        (index) => Expanded(
                                                          child: Row(
                                                    ...
                                                    decoration: InputDecoration(
                                                        hintText: (otpSent ==
                                                            ...
                                                            ? languages[
                                                                    choosenLanguage]
                                                                [
                                                                  //changed from otp to password txt
                                                                'text_enter_password']
                                                            : languages[
                                                                    choosenLanguage]
                                                                [
                                    ...
                                    Button(
                                        ...
                                        onTap: () async {
                                          ...
                                          print('signInsignIn $signIn');
                                          print('newPassword $newPassword');
                                          print('withOtp $withOtp');
                                          print('otpSent $otpSent');
                                                ...
                                                if (exist == true) {
                                                  if (isLoginemail == false) {
                                                    ...
                                                    if (regExp.hasMatch(
                                                      ...
                                                      print('otpCall result: ${val.value}');
                                                      print('valval $val');
                                                      if (val.value == true) {
                                                        if (isCheckFireBaseOTP ==
                                                            true) {
                                                  ...
                                                  if (regex
                                                    ...
                                                    if (verify == false) {
                                                      ...
                                                      print(
                                                          'valvalval ${val.value}');
                                                      print(
                                                          'isCheckFireBaseOTP ${isCheckFireBaseOTP}');
                                                      if (val.value == true) {
                                                        if (isCheckFireBaseOTP ==
                                                            true) {
                                                          await phoneAuth(
  ...
  Future<void> _selectGregorianDate(BuildContext context) async {
    ...
    if (picked != null) {
      _dateOfBirthGregorian.text = intl.DateFormat('dd/MM/yyyy').format(picked);
    }
  }
  ...
  Future<void> selectHijriDate(BuildContext context) async {
              ...
              child: Column(
                ...
                children: [
                  JGlobalDatePicker(
                    ...
                    // or use your choosenLanguage variable
    ...
    if (selectedDate != null) {
      setState(() {
        // Format: DD/MM/YYYY
        _dateOfBirthHijri.text =
            '${selectedDate!.jhijri.day}/${selectedDate!.jhijri.month}/${selectedDate!.jhijri.year}';
      });
    }
  }
}
