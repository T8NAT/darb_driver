...
bool show = true;
double currentRadius = 3.0; // Starting with 3km
...
class _MapsState extends State<Maps>
  ...
  void showNextDestinationDialog(BuildContext context) {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            title: Center(child: Text(languages[choosenLanguage]['text_next_stop'])),
            content: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                Text(tripStops[currentStopIndex]['address'], textAlign: TextAlign.center,),
                SizedBox(height: 20),
                Button(
                  onTap: () {
                    Navigator.pop(context);
                    // Move the map to the next destination
                    updateMapLocation(LatLng(
                        tripStops[currentStopIndex]['latitude'],
                        tripStops[currentStopIndex]['longitude']
                    ));
                  },
  ...
  void updateMapLocation(LatLng location) {
    if (_controller != null) {
      _controller.animateCamera(CameraUpdate.newLatLngZoom(location, 15.0));
    }
  }

  void handleTripProgress() {
    setState(() {
      if (currentStopIndex == 0) {
        // Show the first stop destination pop-up when the trip starts
        showNextDestinationDialog(context);
      } else if (currentStopIndex < tripStops.length - 1) {
        // Move to next stop
        currentStopIndex++;
        showNextDestinationDialog(context);
      } else {
        // Last stop reached, show "End Trip" pop-up
  ...
  void showEndTripDialog(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          backgroundColor: white,
          title: Center(child: Text(languages[choosenLanguage]['text_drop_loc'])),
          actions: [
            Button(
              onTap: () {
                Navigator.pop(context);
              ...
              text: languages[choosenLanguage]['text_endtrip'],
            ),
          ],
        );
      },
...
//getting permission and current location
      ...
      if (serviceEnabled == true) {
        ...
        if (mounted) {
          setState(() {
            ...
            print('myMarkersmyMarkers $myMarkers');
            print("userDetails['role'] ${userDetails['role']}");
            ...
            builder: (context, value, child) {
              ...
              if (navigated == false) {
                ...
                if (((choosenRide.isNotEmpty && _pickAnimateDone == false) ||
                  ...
                  // print(
                  //     "cominggsssgsggsgs $fmPolyGot $_pickAnimateDone $mapType");
                }
                                              ...
                                              : (state == '3')
                                                  ? Stack(
                                                      ...
                                                      children: [
                                                              ...
                                                              ? StreamBuilder<
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return GoogleMap(
                                                                      ...
                                                                      circles: myMarkers.where((e)=>e.markerId.value == '1').isEmpty?{} : <Circle>{
                                                                        Circle(
                                                                          circleId: const CircleId('driverRadius'),
                                                                          center: myMarkers.where((e)=>e.markerId.value == '1').first!.position!,
                                                                          radius: currentRadius * 1000, // 10km in meters
                                                                          fillColor: Colors.blue.withOpacity(0.2),
                                                                          strokeColor: Colors.blue,
                                                                          strokeWidth: 2,
                                                                          visible: true,
                                                                        )
                                                                      }, // Add the circles set here
                                                                      markers: Set<
                                                                          Marker>.from(
                                                                          myMarkers),
                                                                      polylines:
                                                                                                  ...
                                                                                                  Container(
                                                                                                      ...
                                                                                                      child: (driverReq.isNotEmpty)
                                                                                                          ? Text(
                                                                                                              ...
                                                                                                              softWrap: false,
                                                                                                              style: GoogleFonts.almarai(color: textColor, fontSize: (platform == TargetPlatform.android) ? media.width * ten : media.width * twelve),
                                                                                                            )
                                                        ...
                                                        Positioned(
                                                          right: 16,
                                                          bottom: media.width * 1 + 16, // Adjust based on your layout
                                                          child: Container(
                                                            decoration: BoxDecoration(
                                                              color: Colors.white,
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                IconButton( 
                                                                  ...
                                                                  onPressed: () {
                                                                    setState(() {
                                                                      currentRadius = min(currentRadius + 1, 20); // Max 20km
                                                                    });
                                                                    updateMapRadius(currentRadius); // Call update function
                                                                  },
                                                                ),
 ...
 fontSize:12,
                                                                ...
                                                                IconButton( 
                                                                  ...
                                                                  onPressed: () {
                                                                    setState(() {
                                                                      currentRadius = max(currentRadius - 1, 1); // Min 1km
                                                                    });
                                                                    updateMapRadius(currentRadius); // Call update function
                                                                  },
                                                                ),
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child: StatefulBuilder(builder:
                                                                          ...
                                                                          return InkWell(
                                                                              ...
                                                                              child: (userDetails['role'] != 'owner' && userDetails['enable_bidding'] == true)
                                                                              ? Icon(
                                                                            Icons.arrow_back,
                                                                            ...
                                                                            color: textColor,
                                                                              ...
                                                                              : Image.asset(
                                                                            'assets/images/menu.png', // Replace with your actual image path
                                                                    ...
                                                                    ? InkWell(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            'SOS',
                                                                            style:
                                                                                GoogleFonts.almarai(fontSize: media.width * fourteen, color: page),
                                                                          ),
                                                                        ))
                                                                    : Container(),
                                                                const SizedBox(
                                                                                                ...
                                                                                                child: Column(
                                                                                                  ...
                                                                                                  children: [
                                                                                                    Text(
                                                                                                      ...
                                                                                                      style: GoogleFonts.almarai(fontSize: media.width * eighteen, color: textColor),
                                                                                                    ),
                                                                                                  ],
                                                                                                ),
                                                                                              ),
                                                                                              ...
                                                                                              InkWell(
                                                                                                ...
                                                                                                child: Container(
                                                                                                  ...
                                                                                                  child: Text(
                                                                                                    ...
                                                                                                    style: GoogleFonts.almarai(fontSize: media.width * fourteen, fontWeight: FontWeight.w600, color: page),
                                                                                                  ),
                                                                                                ),
                                                                                              ),
                                                                                              SizedBox(
                                                                                                ...
                                                                                                child: TextField(
                                                                                                  ...
                                                                                                  style: GoogleFonts.almarai(fontSize: media.width * sixteen, color: textColor),
                                                                                                ),
                                                                                              ),
                                                                                              InkWell(
                                                                                                onTap: () {
                                                                                ...
                                                                                ? Button(
                                                                                    onTap: () async {
                                                                                      ...
                                                                                      if ((driverReq['is_driver_arrived'] == 0)) {
                                                                                        ...
                                                                                        // showStopDestinationDialog(context);
                                                                                        handleTripProgress();
                                                                                    ...
                                                                                    text: (driverReq['is_driver_arrived'] == 0 || currentStopIndex < tripStops.length)
                                                                                        ...
                                                                                        children: [
                                                                                          ...
                                                                                          SizedBox(
                                                                                            ...
                                                                                            child: Text(
                                                                                              ...
                                                                                              style: GoogleFonts.almarai(fontSize: media.width * fourteen, fontWeight: FontWeight.w600, color: buttonColor),
                                                                                              textAlign: TextAlign.center,
                                                                                              maxLines: 2,
                                                                                              overflow: TextOverflow.ellipsis,
                                                                                            ),
                                                                    ...
                                                                    ? InkWell(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child: Text(
                                                                              ...
                                                                              style: GoogleFonts.almarai(fontSize: media.width * twelve, color: hintColor),
                                                                              textAlign: TextAlign.center),
                                                                        ),
                                                                      )
                                                                    : InkWell(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Center(child: Text(languages[choosenLanguage]['text_edit_shipmentimage'], style: GoogleFonts.almarai(fontSize: media.width * twelve, color: textColor), textAlign: TextAlign.center)),
                                                                        ),
                                                                      )),
                                                        SizedBox(
                                                          height: media.width *
